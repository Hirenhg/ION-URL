  ...
  $(".form").on("submit", function (e) {
    ...
    if (validateForm()) {
      ...
      if (status) {
        ...
        $.post(
          "https://script.google.com/a/macros/ics-global.in/s/AKfycbzB4V5xcRBJtqV7PM5WppB7Oz4Qx-i3ol4JMGd6vVE4QoRPYU08_kfpb3Nw0527ZkTP/exec", // ION_Profile_Creation_Input
